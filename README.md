...
This repository is based on materials for the [ROSCon 2024](https://roscon.ros.org/2024/) workshop on ROS 2 Deliberation Technologies.

__It is designed to support the course on Intelligent Autonomous Systems, but it is also perfectly usable as a guided tutorial to learn all of the presented technologies at your own pace.__
...
> [!NOTE]
> Please make sure you have completed the setup steps before arriving at the Labsession.
...
On macOS you might get asked for your admin password.
...
*After* the initial build completes, you can attach a new terminal to the currently running container by using the terminal command:
